      ...
      <div className="min-h-screen bg-[#F5F2EC] flex items-center justify-center p-4">
        <div className="bg-white rounded-lg border border-[#E5E7EB] shadow-sm p-8 max-w-md text-center">
          ...
          <p className="text-sm text-[#6B7280] mb-6">
            {user.author.verificationStatus === 'REJECTED'
              ? 'Your verification was rejected. Please contact support.'
              : 'Your author account is pending admin approval. You will receive an email once verified.'}
          </p>
          <a
            href="/"
            className="bg-[#4B5D45] hover:bg-[#3E4C39] text-white px-6 py-2.5 rounded-lg text-sm font-medium transition-colors inline-block"
          >
            Back to Store
          </a>
        </div>
